...
//		}
		...
		for (String string: profile.getOrcidIdentifier().getValue()){
			if (string != null)
				setOrcid_id(string);
		}
		...
		if (profile.getOrcidBio() != null) {
			...
			if (updateValue(name.getFamilyName().getContent(), getLastName())) {
				setLastName(name.getFamilyName().getContent());
			}

			if (updateValue(name.getGivenNames().getContent(), getFirstName())) {
				setFirstName(name.getGivenNames().getContent());
			}

			if (name.getCreditName() != null) {
				if (StringUtils.isNotBlank(name.getCreditName().getContent())) {
			...
			if (name.getOtherNames() != null) {
				for (OtherName otherName : name.getOtherNames().getOtherName()) {
			...
			if (profile.getOrcidBio().getContactDetails() != null) {
				if (profile.getOrcidBio().getContactDetails().getAddress() != null) {
					if (profile.getOrcidBio().getContactDetails().getAddress().getCountry() != null) {
						if (updateOtherMetadata("country",profile.getOrcidBio().getContactDetails().getAddress().getCountry().toString())) {
							addOtherMetadata("country",profile.getOrcidBio().getContactDetails().getAddress().getCountry().toString());
						}
					}
				}
			}
			...
			if (profile.getOrcidBio().getBiography() != null) {
				if (updateOtherMetadata("biography", profile.getOrcidBio().getBiography().getContent())) {
					addOtherMetadata("biography", profile.getOrcidBio().getBiography().getContent());
				}
			}
