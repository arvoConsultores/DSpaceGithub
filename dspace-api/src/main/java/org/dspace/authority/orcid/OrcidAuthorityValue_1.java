 ...
 */
public class OrcidAuthorityValue_1 extends PersonAuthorityValue {

    /**
     * log4j logger
     */
    private static Logger log = Logger.getLogger(OrcidAuthorityValue_1.class);
     ...
     */
    public OrcidAuthorityValue_1() {
    }

    public OrcidAuthorityValue_1(SolrDocument document) {
        super(document);
    }
    ...
    public static OrcidAuthorityValue_1 create() {
        OrcidAuthorityValue_1 orcidAuthorityValue = new OrcidAuthorityValue_1();
     ...
     */
    public static OrcidAuthorityValue_1 create(Bio bio) {
        OrcidAuthorityValue_1 authority = OrcidAuthorityValue_1.create();
    ...
    public AuthorityValue newInstance(String info) {
        ...
        if (StringUtils.isNotBlank(info)) {
            ...
            authorityValue = OrcidAuthorityValue_1.create();
        }
    ...
    public boolean equals(Object o) {
        ...
        OrcidAuthorityValue_1 that = (OrcidAuthorityValue_1) o;
