...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:import href="core/bug-fixes.xsl"/>
    <xsl:import href="aspect/authoritycontrol/authoritycontrol.xsl"/>
    ...
    <xsl:import href="modules/item-view-buttons.xsl"/>
    <xsl:import href="modules/video.xsl"/>
